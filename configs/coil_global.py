...
_g_conf.TRAIN_DATASET_NAMES = [] # 8/31/2019: add this attribute to support multiple datasets
...
_g_conf.USE_REPRESENTATION_LOSS = False
_g_conf.EXPERT_EXP_FOLDER = None
_g_conf.EXPERT_EXP = None
_g_conf.PERCEPTION_REP_SIZE = 512
_g_conf.PERCEPTION_REP_WEIGHT = 0.333
_g_conf.SPEED_REP_WEIGHT = 0.333
_g_conf.INTENTIONS_REP_WEIGHT = 0.334
_g_conf.REP_LOSS_WEIGHT = 1.0
_g_conf.USE_PERCEPTION_REP_LOSS = True
_g_conf.USE_INTENTION_REP_LOSS = True
_g_conf.USE_SPEED_REP_LOSS = True
_g_conf.SEPARATE_PERCEPTION_INTENTION_REPS = False
...
def set_type_of_process(process_type, param=None):
    ...
    # 10/6/2019: add process type of test (for comma.ai evaluation)
